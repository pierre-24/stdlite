...
void make_int1e_MO(stdl_wavefunction *wf, stdl_basis *bs, stdl_operator op, stdl_context *ctx, double *dipoles_sp_MO) {
    ...
    ASSERT_STDL_OK(stdl_operator_int1e_dsp(bs, op, dipoles_sp_AO));
